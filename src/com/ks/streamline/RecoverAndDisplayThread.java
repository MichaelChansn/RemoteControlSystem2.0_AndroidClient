...
public class RecoverAndDisplayThread extends Thread {
    ...
    public RecoverAndDisplayThread(TcpNet tcpNet,MyHandler hander,LinkedBlockingQueue<BitmapWithCursor> difBtmQueue,LinkedBlockingQueue<BitmapWithCursor> displayQueue)
    {
    	if(tcpNet==null || difBtmQueue==null || hander==null)
    		throw new RuntimeException("RecoverAndDisplayThread constructor params can not be null except displayQueue");
    	this.hander=hander;
