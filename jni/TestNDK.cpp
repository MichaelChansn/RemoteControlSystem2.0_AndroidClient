...
#include <cstring>
#include <unistd.h>
#include <com_ks_testndk_JNItest.h>
...
JNIEXPORT void JNICALL Java_com_ks_testndk_JNITest_finsh(JNIEnv *env, jobject jObject)
{
	if(bitmapCls!=NULL){
...
JNIEXPORT jobject JNICALL Java_com_ks_testndk_JNITest_getBitmapNew(JNIEnv *env, jobject jObject, jintArray points, jobject globalBtm, jobject lastBtm)
{
		void * pixelsG = NULL;
		void * pixelsL=NULL;
...
JNIEXPORT void JNICALL Java_com_ks_testndk_JNITest_getBitmapOrl(JNIEnv *env, jobject jObject, jintArray points, jobject globalBtm, jobject lastBtm)
{
		void * pixelsG = NULL;
		void * pixelsL = NULL;
	    int resG = AndroidBitmap_lockPixels(env, globalBtm, &pixelsG);
